exports.run = (client, message, args) => {
    ...
    message.delete();
    message.channel.send("@everyone Retrouvez ce soir AdryNeko, KitsuneMiu, Roy must'hang, NaruSnake, DrLinkInk pour un stream spécial Halloween sur Dead By Daylight sur les chaînes Twitch et Youtbe de DrLinkInk&Cie et NaruSnake comme ça vous aurez 2 vues différentes. Tenez vous prêt aux alentours de 21h pour le massacre.").catch(console.error);
